...
import at.tugraz.ist.ase.ao4crs.model.translator.core.MZN2ChocoBaseListener;
import at.tugraz.ist.ase.ao4crs.model.translator.core.MZN2ChocoLexer;
import at.tugraz.ist.ase.ao4crs.model.translator.core.MZN2ChocoParser;
...
public class MZN2ChocoTranslator extends MZN2ChocoBaseListener {
    ...
    private ItemAwareConfigurationModel model;

    private final Stack<String> ruleParts = new Stack<>();

    public void translate(InputStream inputFile, ItemAwareConfigurationModel model) throws IOException {
